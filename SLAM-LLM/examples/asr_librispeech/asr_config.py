...
class ModelConfig:
    ...
    llm_name: str = "TinyLlama-1.1B"
    llm_path: str = "PATH/to/TinyLlama/1.1B"
    llm_type: str = "decoder_only"
    llm_dim: int = 2048
    feature_pooling: str = field(
        default="mean",
        metadata={"help": "Feature pooling method: mean, max, attention, first, cls"}
    )
    use_dropout: bool = field(
        default=True,
        metadata={"help": "Whether to use dropout"}
    )
    ...
    input_type: str = field(
        default="raw",
        metadata={"help": "Input type: raw or mel"}
    )
...
class TrainConfig:
    ...
    use_data_augmentation: bool = field(
        default=True,
        metadata={"help": "Whether to use data augmentation during training"}
    )
    ...
    run_test: bool = field(
        default=False,
        metadata={"help": "Whether to run test during training"}
    )
...
class LogConfig:
    ...
    wandb_dir: str = "/home/liu.ten/demo/test_wandb"
    wandb_entity_name: str = "arno-liut-northeastern-university"
    wandb_project_name: str = "hate_speech_detection"
    wandb_exp_name: str = "exp_2"
